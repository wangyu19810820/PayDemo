    ...
    public static void main(String[] args) throws AlipayApiException, ClassNotFoundException {
        for (int i = 2; i <= 2; i++) {
            ...
            TestResponse resultOldXml = null;
            {
                ...
                String caseString = Util.read("test/cases/" + i + "/case-new.json");
            ...
            }
            {
                ...
                String caseString = Util.read("test/cases/" + i + "/case-old.json");
                System.out.println(caseString);
            ...
            }
            {
                ...
                String caseString = Util.read("test/cases/" + i + "/case-old.xml");
                System.out.println(caseString);
